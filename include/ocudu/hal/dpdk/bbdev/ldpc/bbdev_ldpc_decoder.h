...
/// \file
/// \brief Definition of the specific functions used by the bbdeb-based
/// hardware-accelerated LDPC decoder implementations.
...
uint16_t compute_softdata_len(::rte_bbdev_op_ldpc_dec& dec_cfg);
