...
/// Computes the Euclidean norm (magnitude) of a 3D point.
...
/// Divides a coord_3d vector by a scalar value.
...
/// Subtracts one state vector from another one.
...
/// Multiplies a state vector by a scalar value.
...
/// Divides a state vector by a scalar value.
/// \param a The state_vector to scale.
/// \param scalar The scalar value.
/// \return The result of scaling state vector by scalar.
inline state_vector operator/(const state_vector& a, double scalar)
