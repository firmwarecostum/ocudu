...
private:
  ...
  /// \return The ephemeris information if available, or an error.
  expected<orbit_ephemeris_info*> get_ephemeris_info(time_point t);
  ...
  /// \return The NTN gateway location information if available, or an error.
  expected<const ntn_gateway_location_info*> get_ntn_gateway_location_info(time_point t);
