...
precoding_weight_matrix ocudu::make_type1_sp_mode1(const precoding_matrix_indicator& pmi, unsigned nof_layers)
{
  ...
  switch (nof_layers) {
    case 1: {
      layer_beam_horizontal.assign({i_1_1});
      layer_beam_vertical.assign({i_1_2});
      layer_pol.assign({phi});
      break;
    }
    case 2: {
      // Beam offset between layers for different N1xN2 combinations, indexed by i_1_3, as per TS 38.214
      // Table 5.2.2.2.1-3,
      static_vector<unsigned, 4> k1(nof_possible_beam_offsets);
      static_vector<unsigned, 4> k2(nof_possible_beam_offsets);
      ...
      if ((panel_info.n1 == 2) && (panel_info.n2 == 1)) {
        ...
        // Unreachable code.
        ocudu_assert(false, "Unsupported Type I Single-Panel configuration.");
      }

      layer_beam_horizontal.assign({i_1_1, i_1_1 + k1[i_1_3]});
      layer_beam_vertical.assign({i_1_2, i_1_2 + k2[i_1_3]});
    ...
    case 4: {
      ...
      layer_beam_horizontal.assign({i_1_1, i_1_1 + k1[i_1_3], i_1_1, i_1_1 + k1[i_1_3]});
      layer_beam_vertical.assign({i_1_2, i_1_2 + k2[i_1_3], i_1_2, i_1_2 + k2[i_1_3]});
      layer_pol.assign({phi, phi, -phi, -phi});
      break;
    }
    case 5: {
      if (is_2d_panel) {
        layer_beam_horizontal.assign({i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1, i_1_1 + o1});
      } else {
        layer_beam_horizontal.assign({i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1, i_1_1 + 2 * o1});
      }

      layer_beam_vertical.assign({i_1_2, i_1_2, i_1_2, i_1_2, i_1_2 + o2});
      layer_pol.assign({phi, -phi, 1.0f, -1.0f, 1.0f});
      break;
    }
    case 6: {
      if (is_2d_panel) {
        layer_beam_horizontal.assign({i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1, i_1_1 + o1, i_1_1 + o1});
      } else {
        layer_beam_horizontal.assign({i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1, i_1_1 + 2 * o1, i_1_1 + 2 * o1});
      }

      layer_beam_vertical.assign({i_1_2, i_1_2, i_1_2, i_1_2, i_1_2 + o2, i_1_2 + o2});
      layer_pol.assign({phi, -phi, phi, -phi, 1.0f, -1.0f});
      break;
    }
    case 7: {
      if (is_2d_panel) {
        layer_beam_horizontal.assign({i_1_1, i_1_1, i_1_1 + o1, i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1});
      } else {
        layer_beam_horizontal.assign(
            {i_1_1, i_1_1, i_1_1 + o1, i_1_1 + 2 * o1, i_1_1 + 2 * o1, i_1_1 + 3 * o1, i_1_1 + 3 * o1});
      }

      layer_beam_vertical.assign({i_1_2, i_1_2, i_1_2, i_1_2 + o2, i_1_2 + o2, i_1_2 + o2, i_1_2 + o2});
      layer_pol.assign({phi, -phi, phi, 1.0f, -1.0f, 1.0f, -1.0f});
      break;
    }
    case 8: {
      if (is_2d_panel) {
        layer_beam_horizontal.assign({i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1, i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1});
      } else {
        layer_beam_horizontal.assign(
            {i_1_1, i_1_1, i_1_1 + o1, i_1_1 + o1, i_1_1 + 2 * o1, i_1_1 + 2 * o1, i_1_1 + 3 * o1, i_1_1 + 3 * o1});
      }

      layer_beam_vertical.assign({i_1_2, i_1_2, i_1_2, i_1_2, i_1_2 + o2, i_1_2 + o2, i_1_2 + o2, i_1_2 + o2});
      layer_pol.assign({phi, -phi, phi, -phi, 1.0f, -1.0f, 1.0f, -1.0f});
      break;
    }
    default:
